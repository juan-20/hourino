		...
		<header className="border-border border-b-2 bg-background">
			<div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4">
				<Link
					...
					className="rounded-sm font-bold text-2xl tracking-tight outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
					to="/"
				>
					hourino
				</Link>
