...
const attachmentVariants = cva(
	"group/attachment relative flex w-fit min-w-0 max-w-full shrink-0 flex-wrap rounded-md border-2 border-border bg-card text-card-foreground transition-colors focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-within:ring-offset-background has-[>a,>button]:hover:bg-muted/50 data-[state=error]:border-destructive/30 data-[state=idle]:border-dashed",
	{
		variants: {
			orientation: {
			...
			size: {
				...
				xs: "gap-1.5 rounded-sm text-xs has-data-[slot=attachment-media]:p-1 has-data-[slot=attachment-content]:px-1.5 has-data-[slot=attachment-content]:py-1",
			},
		},
	}
);
