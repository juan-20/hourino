...
function Empty({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			className={cn(
				"flex w-full min-w-0 flex-1 flex-col items-center justify-center gap-4 text-balance rounded-lg border-2 border-border border-dashed p-6 text-center md:p-12",
				className
			)}
			data-slot="empty"
			{...props}
