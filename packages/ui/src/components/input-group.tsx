...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			className={cn(
				"group/input-group relative flex h-8 w-full min-w-0 items-center rounded-md border-2 border-border bg-background outline-none transition-[color,box-shadow] has-[>textarea]:h-auto dark:bg-input/30",
